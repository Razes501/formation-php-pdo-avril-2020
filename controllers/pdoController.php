...
//Il faut alors récupérer les infos de la personne depuis la bdd
...
if($id>0 && !$isPosted){
    try{
        ...
        $pageTitle = "Erreur";
        $errorMessage = "Une erreur de saisie empêche la lecture des infos d'une personne sur la base de données";
...
//traitement du formaulaire si les données sont postées
if ($isPosted){
    ...
    $pageTitle = "Erreur";
    $errorMessage = "Une erreur de saisie empêche la création d'une personne";
    $content = "../views/error.php";
