...
VALUES ('Développeur'), ('Chef de projet'), ('Mathématicien'), ('Ecrivain'), ('Formateur');
...
-- Creation de la vue pour simplifier les requêtes sur les personnes
...
SELECT p.id, person_name, first_name, zip_code, city, 
        ...
        FROM persons AS p 
            LEFT JOIN adresses ON p.id = person_id
